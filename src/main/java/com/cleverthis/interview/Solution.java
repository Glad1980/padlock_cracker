 ...
 * <li>Here, you can add any methods to solve padlock using various
 * connector.</li>
 * </ul>
 */
public class Solution {
    ...
    public void solve(PadlockImpl padlock) {
        if(padlock == null)throw new IllegalArgumentException("padlock must be initilized");
        IPadlockConnector padlockObjectCon = new PadlockObjectConnector(padlock);
        padlockCracker.crack(padlockObjectCon);
    }
